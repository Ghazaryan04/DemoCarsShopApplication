package ge.tsu.DemoCarsShopApplication.controller.profile;

import ge.tsu.DemoCarsShopApplication.entiti.Comment;
import ge.tsu.DemoCarsShopApplication.service.CommentService;
...
public class ProfileController {
    ...
    public String profile(Model model,
        ...
        Page<Comment> comments = commentService.getAllCommentsByAuthor(authentication.getName(), page, size);
...
//        PostDto post = commentService.createPost(username, form.getTitle(), form.getContent());
...
//                               Model model) {
//        PostDto post = commentService.getPostById(id);
...
//            return "profile/post-edit";
//        }
//        commentService.updatePost(id, principal.getName(), form.getTitle(), form.getContent());
